  ...
  <div id="login-wrapper" class="Login">
    ...
    <article id="login">
        ...
        <div class="Login-header">
          <img class="Logo" src="images/Cisco_Logo.svg" />
        ...
        <form id="login-form" class="Login-form" method="post" name="login-form" action="https://sso-test.cisco.com/autho/login/loginaction.html">
          ...
          <input id="login-button" class="button-cta default-command-button Button-primary Button--full" type="submit" name="login-button" data-value="LOGIN_LOCAL_CONTENT_BTN_LOGIN" value="Sign In">
        </form>
        ...
        <div class="Login-footer">
          <span>POWERED BY</span> CISCO METACLOUD
        </div>
